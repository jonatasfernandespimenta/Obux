      ...
      <Container>
        <Header>
          <User>
            ...
            <UserImage
              source={{
                uri: pfp.includes('http://192.168.100.68:3000/files/') ? 
                  uri.pfp : 'http://192.168.100.68:3000/files/' + pfp,
                isStatic: true
              }}
            />
            </TouchableOpacity>
          ...
          {book?.foto && (
            <BookImage
            source={{
              uri: book.foto.includes('http://192.168.100.68:3000/files/') ? 
              book.foto : 'http://192.168.100.68:3000/files/' + book.foto,
              isStatic: true
            }}
            />
          )}
