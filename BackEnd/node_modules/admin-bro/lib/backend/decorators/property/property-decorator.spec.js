...
describe('PropertyDecorator', () => {
  ...
  describe('#toJSON', () => {
    it('returns JSON representation of a property', () => {
      (0, _chai.expect)(new _propertyDecorator.default(args).toJSON()).to.have.keys('isTitle', 'isId', 'position', 'isSortable', 'availableValues', 'name', 'label', 'type', 'reference', 'components', 'isDisabled', 'subProperties', 'isArray', 'custom', 'resourceId', 'propertyPath', 'isRequired', 'isVirtual', 'props', 'hideLabel');
    });
  });
  afterEach(() => {
