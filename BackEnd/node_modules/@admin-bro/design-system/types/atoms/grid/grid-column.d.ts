...
export declare type GridColumnProps = {} & GridProps;
declare const GridColumn: import("styled-components").StyledComponent<"section", import("styled-components").DefaultTheme, import("styled-system").SpaceProps<Required<import("styled-system").Theme<string | number>>, string | number | symbol> & Pick<import("styled-system").ColorProps<Required<import("styled-system").Theme<string | number>>, string | number | symbol>, "opacity" | "backgroundColor" | "bg"> & {
...
} & GridProps<Required<import("styled-system").Theme<string | number>>>, never>;
export { GridColumn as default, GridColumn, };
