...
const getDeletedFiles_1 = require("./getDeletedFiles");
...
function tapStartToConnectAndRunReporter(compiler, reporter, configuration, state) {
    ...
    compiler.hooks.compilation.tap('ForkTsCheckerWebpackPlugin', (compilation) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (state.watching) {
            change = {
                changedFiles: getChangedFiles_1.getChangedFiles(compilation.compiler),
                deletedFiles: getDeletedFiles_1.getDeletedFiles(compilation.compiler),
            };
