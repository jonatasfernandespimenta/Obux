...
export declare class ValidationPipe implements PipeTransform<any> {
    ...
    protected mapChildrenToValidationErrors(error: ValidationError): ValidationError[];
    protected prependConstraintsWithParentProp(parentError: ValidationError, error: ValidationError): ValidationError;
}
